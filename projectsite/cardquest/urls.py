...
urlpatterns = [
    ...
    path('pokemon_card/<pk>', views.PokemonCardUpdateView.as_view(), name='pokemon-card-edit'),
    path('pokemon_card/<pk>/delete', views.PokemonCardDeleteView.as_view(), name='pokemon-card-del'),
    ...
    path('collection/<pk>', views.CollectionUpdateView.as_view(), name='collection-edit'),
    path('collection/<pk>/delete', views.CollectionDeleteView.as_view(), name='collection-del'),
